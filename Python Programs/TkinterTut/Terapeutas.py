...
def mostrarImagen():
    ...
    logo = ImageTk.PhotoImage(Image.open("D:\\GitHub Repos\\Python\\Python Programs\\TransicionesTerapeutas\\Logo.png"))
...
def adminLogin():
    ...
    def regresarAdmin(ventana):
        ...
        logo = ImageTk.PhotoImage(
            Image.open("D:\\GitHub Repos\\Python\\Python Programs\\TransicionesTerapeutas\\Logo.png"))
        labelLogo = Label(adminLog, image=logo)
        labelLogo.grid(row=0, column=0, columnspan=3)
    ...
    def agregarUsuario():
        ...
        def subirUsuario():
            ...
            conn = sqlite3.connect('Databases\\Terapeutas.db')
...
# cursor.execute("DELETE from terapeuta WHERE Nombre is null or Nombre = '' ")
# cursor.execute("DELETE from login WHERE Usuario is null or Usuario = '' ")
